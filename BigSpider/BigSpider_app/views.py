...
def crawling_info(request):
    ...
    if "username" in request.session:
        ...
        flag = True
    if flag:
        crawling_web_info = mongodb_options.crawling_web_info(uestc)
        crawling_succeed_num = mongodb_options.crawling_succeed_num(uestc)
        ...
        return render(request, 'crawling_info.html', {'login_user': username, 'crawling_web_info': crawling_web_info,
                                                      'crawling_succeed_num': crawling_succeed_num, 'flag': flag})
    else:
